...
namespace FormGenerator.Client.App_Start
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/viewport").Include("~/Scripts/app/app.js", "~/Scripts/app/utils/*.js", "~/Scripts/app/utils/editor/*.js", "~/Scripts/app/utils/components/*.js"));
